...
class LLMGuard:
    ...
    def process_results(self, user_question: str, results: str) -> Tuple[bool, str]:
        ...
        while True:
            ...
            if output.lower().endswith("attack detected: true"):
                thought = output.split("Attack detected: ")[0].strip()
                return True, thought
            elif output.lower().endswith("attack detected: false"):
                thought = output.split("Attack detected: ")[0].strip()
