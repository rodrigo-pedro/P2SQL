...
class SQLDatabaseChain(Chain):
    ...
    *Security note*: Make sure that the database connection uses credentials
    ...
    # 1. pre_sql_exec_callbacks: called before the sql command is executed
    # 2. post_sql_exec_callbacks: called after the sql command is executed
    ...
    def _call(
        ...
        try:
            ...
            for callback in self.post_sql_exec_callbacks:
                result = callback(input_text, sql_cmd, result)
