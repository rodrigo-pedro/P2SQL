...
VALUES
    ...
    ('DevOps Engineer', 'We are looking for a skilled DevOps engineer to help us automate our infrastructure and improve our deployment processes.', 'Cloud Services', 'London', 10000, 1),
    ('Engineer', 'DESCRIPTION', 'A Cool Company', 'Lisbon', 95000, 2);
