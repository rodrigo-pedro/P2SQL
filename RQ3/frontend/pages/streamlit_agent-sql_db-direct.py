...
class StreamlitAgentSqlDbDirect(ChatTemplate):
...
app = StreamlitAgentSqlDbDirect(
    "streamlit_agent-sql_db", info_text=info_text, has_history=False, models=["gpt-3.5-turbo-1106", "gpt-4-0613"], possible_attack_types=["RD1"]
)
